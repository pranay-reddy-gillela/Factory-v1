        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div>
            ...
            <form
              ...
              className="space-y-6"
            >
              <input type="hidden" name="access_key" value="807983bb-e7a4-475d-87ba-6db5c9c95404" />
              ...
              <button
                type="submit"
                className="w-full bg-green-600 text-white py-3 rounded font-semibold hover:bg-blue-700 transition"
              >
                Submit And Get Quotation
              </button>
            </form>
          </div>
          ...
          <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 9490127350</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">pranayreddygillela@gmail.com</p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6">
              <button
                onClick={() =>
                  window.open(
                    'https://maps.google.com/?q=sri+sai+balaji+spun+pipes+mahabubnagar',
                    '_blank'
                  )
                }
